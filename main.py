...
def attack(char_name: str, char_class: str) -> str:
    """Определяем величину урона, нанесенного противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяем величину блокированного урона."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Начинаем тренировку. Выбираем активное действие."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описание классов для персонажа."""
    approve_choice: str = ''
    char_class: str = ''
...
def main() -> None:
    """Ввод имени игрока и выбор класса."""
